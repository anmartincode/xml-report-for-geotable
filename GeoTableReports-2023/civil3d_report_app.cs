...
[assembly: CommandClass(typeof(GeoTableReports.ReportCommands2023))]
...
namespace GeoTableReports
{
    ...
    public class ReportCommands2023 : IExtensionApplication, IReportGenerator
    {
        ...
        public void GenerateReport()
        {
            ...
            try
            {
                ...
                AlignmentPreviewData2023 previewData = BuildAlignmentPreviewData(alignmentId);

                using (var dialog = new ReportSelectionForm2023(previewData))
                {
                    ...
                    using (Transaction tr = doc.Database.TransactionManager.StartTransaction())
                    {
                        ...
                        ProgressStatusWindow2023 progressWindow = null;
                        if (totalSteps > 0)
                        {
                            progressWindow = new ProgressStatusWindow2023(totalSteps);
                            progressWindow.Show();
        ...
        private void ExecuteReportGeneration(
            ...
            ProgressStatusWindow2023 progressWindow,
        ...
        private AlignmentPreviewData2023 BuildAlignmentPreviewData(ObjectId alignmentId)
        {
            var data = new AlignmentPreviewData2023();
            try
            {
                AcApp.Document doc = AcApp.Application.DocumentManager.MdiActiveDocument;
                using (Transaction tr = doc.Database.TransactionManager.StartTransaction())
        ...
        private void PopulateAlignmentMetadata(CivDb.Alignment alignment, AlignmentPreviewData2023 data)
        {
        ...
        private void PopulateHorizontalSamples(CivDb.Alignment alignment, AlignmentPreviewData2023 data)
        {
        ...
        private void AddHorizontalSampleLine(CivDb.Alignment alignment, AlignmentEntity e, int index, AlignmentPreviewData2023 data)
        {
            switch (e.EntityType)
            {
        ...
        private void PopulateVerticalSamples(CivDb.Alignment alignment, AlignmentPreviewData2023 data)
        {
            try
            {
        ...
        private void AddVerticalSampleLine(ProfileEntity pe, AlignmentPreviewData2023 data)
        {
        ...
        private void AddGeoTableCurvePdf(iText.Layout.Element.Table table, AlignmentArc arc, CivDb.Alignment alignment, int index, int curveNumber, PdfFont font, AlignmentEntity prevEntity, AlignmentEntity nextEntity, System.Collections.Generic.List<AlignmentEntity> sortedEntities)
        {
            ...
            var curveNoCell = new iText.Layout.Element.Cell(3, 1).Add(new Paragraph(curveLabel).SetFont(font).SetFontSize(6.5f))
                ...
                .SetVerticalAlignment(iText.Layout.Properties.VerticalAlignment.MIDDLE)
                .SetBorder(new SolidBorder(ColorConstants.BLACK, 0.5f));
            curveNoCell.SetNextRenderer(new OvalCellRenderer2023(curveNoCell));
    ...
    public class AlignmentPreviewData2023
    {
    ...
    public class ReportSelectionForm2023 : Form
    {
        private AlignmentPreviewData2023 previewData; // injected preview metadata & sample lines
        ...
        public ReportSelectionForm2023(AlignmentPreviewData2023 preview)
        {
            previewData = preview ?? new AlignmentPreviewData2023();
    ...
    public class ProgressStatusWindow2023 : Form
    {
        ...
        public ProgressStatusWindow2023(int steps)
        {
            totalSteps = steps;
            currentStep = 0;
    ...
    public class OvalCellRenderer2023 : CellRenderer
    {
        public OvalCellRenderer2023(iText.Layout.Element.Cell modelElement) : base(modelElement)
        {
        }
        ...
        {
            return new OvalCellRenderer2023((iText.Layout.Element.Cell)GetModelElement());
        }
    }
